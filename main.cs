...
// Command-line arguments: run --no-verify /Users/zaramihnea/Developer/Uni/An3Sem1/VDPD/blockchain_verified/main.dfy
// main.dfy
...
class Blockchain {
  ...
  predicate Valid()
    reads this, chain, chain[..], this
    decreases (set _s2s_0: Block? {:trigger _s2s_0 in chain} | _s2s_0 in chain :: _s2s_0) + (set _s2s_1: Block? {:trigger _s2s_1 in chain[..]} | _s2s_1 in chain[..] :: _s2s_1) + {this, this}
  {
    |chain| > 0 &&
    forall i: int {:trigger chain[i]} :: 
      0 <= i < |chain| ==>
        |chain[i].hash| > 0
  }
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      Blockchain _0_blockchain;
      Blockchain _nw0 = new Blockchain();
      _nw0.__ctor();
      _0_blockchain = _nw0;
      Transaction _1_transaction1;
      Transaction _nw1 = new Transaction();
      _nw1.__ctor(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Alice"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Bob"), new BigInteger(50));
      _1_transaction1 = _nw1;
      if ((new BigInteger((_0_blockchain.chain).Count)).Sign == 1) {
        Dafny.ISequence<Dafny.Rune> _2_previousHash;
        _2_previousHash = (_0_blockchain.chain).Select((new BigInteger((_0_blockchain.chain).Count)) - (BigInteger.One)).hash;
        Block _3_newBlock;
        Block _nw2 = new Block();
        _nw2.__ctor(new BigInteger(2), Dafny.Sequence<Transaction>.FromElements(_1_transaction1), _2_previousHash);
        _3_newBlock = _nw2;
        bool _4_mined;
        bool _out0;
        _out0 = (_3_newBlock).Mine(new BigInteger(2));
        _4_mined = _out0;
        if (_4_mined) {
          bool _5_success;
          bool _out1;
          _out1 = (_0_blockchain).AddBlock(_3_newBlock);
          _5_success = _out1;
          if (_5_success) {
            Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Block #1 added successfully.\n")).ToVerbatimString(false));
          } else {
            Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Failed to add block #1.\n")).ToVerbatimString(false));
          }
        } else {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Mining for block #1 failed.\n")).ToVerbatimString(false));
        }
      }
      Transaction _6_transaction3;
      Transaction _nw3 = new Transaction();
      _nw3.__ctor(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Charlie"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Dave"), new BigInteger(75));
      _6_transaction3 = _nw3;
      if ((new BigInteger((_0_blockchain.chain).Count)).Sign == 1) {
        Dafny.ISequence<Dafny.Rune> _7_previousHash2;
        _7_previousHash2 = (_0_blockchain.chain).Select((new BigInteger((_0_blockchain.chain).Count)) - (BigInteger.One)).hash;
        Block _8_newBlock2;
        Block _nw4 = new Block();
        _nw4.__ctor(new BigInteger(3), Dafny.Sequence<Transaction>.FromElements(_6_transaction3), _7_previousHash2);
        _8_newBlock2 = _nw4;
        bool _9_mined2;
        bool _out2;
        _out2 = (_8_newBlock2).Mine(new BigInteger(2));
        _9_mined2 = _out2;
        if (_9_mined2) {
          bool _10_success2;
          bool _out3;
          _out3 = (_0_blockchain).AddBlock(_8_newBlock2);
          _10_success2 = _out3;
          if (_10_success2) {
            Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Block #2 added successfully.\n")).ToVerbatimString(false));
          } else {
            Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Failed to add block #2.\n")).ToVerbatimString(false));
          }
        } else {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Mining for block #2 failed.\n")).ToVerbatimString(false));
        }
      }
      Transaction _11_transaction5;
      Transaction _nw5 = new Transaction();
      _nw5.__ctor(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Alice"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Frank"), new BigInteger(20));
      _11_transaction5 = _nw5;
      if ((new BigInteger((_0_blockchain.chain).Count)).Sign == 1) {
        Dafny.ISequence<Dafny.Rune> _12_previousHash3;
        _12_previousHash3 = (_0_blockchain.chain).Select((new BigInteger((_0_blockchain.chain).Count)) - (BigInteger.One)).hash;
        Block _13_newBlock3;
        Block _nw6 = new Block();
        _nw6.__ctor(new BigInteger(4), Dafny.Sequence<Transaction>.FromElements(_11_transaction5), _12_previousHash3);
        _13_newBlock3 = _nw6;
        bool _14_mined3;
        bool _out4;
        _out4 = (_13_newBlock3).Mine(new BigInteger(2));
        _14_mined3 = _out4;
        if (_14_mined3) {
          bool _15_success3;
          bool _out5;
          _out5 = (_0_blockchain).AddBlock(_13_newBlock3);
          _15_success3 = _out5;
          if (_15_success3) {
            Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Block #3 added successfully.\n")).ToVerbatimString(false));
          } else {
            Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Failed to add block #3.\n")).ToVerbatimString(false));
          }
        } else {
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Mining for block #3 failed.\n")).ToVerbatimString(false));
        }
      }
      if ((_0_blockchain).Valid()) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Blockchain is valid.\n")).ToVerbatimString(false));
      } else {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Blockchain is invalid.\n")).ToVerbatimString(false));
      }
      (_0_blockchain).PrintBlockchain();
    }
  }

  public partial class Transaction {
    public Transaction() {
      this.sender = Dafny.Sequence<Dafny.Rune>.Empty;
      this.destination = Dafny.Sequence<Dafny.Rune>.Empty;
      this.amount = BigInteger.Zero;
    }
    public Dafny.ISequence<Dafny.Rune> sender {get; set;}
    public Dafny.ISequence<Dafny.Rune> destination {get; set;}
    public BigInteger amount {get; set;}
    public void __ctor(Dafny.ISequence<Dafny.Rune> s, Dafny.ISequence<Dafny.Rune> d, BigInteger a)
    {
      (this).sender = s;
      (this).destination = d;
      (this).amount = a;
    ...
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("    Transaction:\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("      Sender: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((this.sender).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n      Destination: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((this.destination).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n      Amount: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((this.amount));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
  ...
  public partial class Block {
    public Block() {
      ...
      this.transactions = Dafny.Sequence<Transaction>.Empty;
      this.previousHash = Dafny.Sequence<Dafny.Rune>.Empty;
      this.hash = Dafny.Sequence<Dafny.Rune>.Empty;
      this.hashAttempts = BigInteger.Zero;
    }
    public BigInteger timestamp {get; set;}
    public Dafny.ISequence<Transaction> transactions {get; set;}
    public Dafny.ISequence<Dafny.Rune> previousHash {get; set;}
    public Dafny.ISequence<Dafny.Rune> hash {get; set;}
    public BigInteger hashAttempts {get; set;}
    public bool Valid() {
      return ((((this.timestamp).Sign == 1) && ((new BigInteger((this.previousHash).Count)).Sign == 1)) && ((new BigInteger((this.hash).Count)).Sign == 1)) && ((this.hashAttempts).Sign != -1);
    }
    public void __ctor(BigInteger time, Dafny.ISequence<Transaction> tran, Dafny.ISequence<Dafny.Rune> prevHash)
    {
      (this).timestamp = time;
      (this).transactions = tran;
      (this).previousHash = prevHash;
      (this).hashAttempts = BigInteger.Zero;
      (this).hash = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("initial");
    }
    public bool Mine(BigInteger difficulty)
    {
      bool success = false;
      (this).hashAttempts = (this.hashAttempts) + (BigInteger.One);
      (this).hash = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("mined_hash");
      success = true;
      return success;
    }
    public void PrintBlock()
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Block:\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("  Timestamp: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((this.timestamp));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n  Previous Hash: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((this.previousHash).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n  Hash: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((this.hash).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n  Transactions:\n")).ToVerbatimString(false));
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      while ((_0_i) < (new BigInteger((this.transactions).Count))) {
        ((this.transactions).Select(_0_i)).PrintTransaction();
  ...
  public partial class Blockchain {
    public Blockchain() {
      this.chain = Dafny.Sequence<Block>.Empty;
    }
    public Dafny.ISequence<Block> chain {get; set;}
    public bool Valid() {
      return ((new BigInteger((this.chain).Count)).Sign == 1) && (Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((this.chain).Count)), true, (((_forall_var_0) => {
        BigInteger _0_i = (BigInteger)_forall_var_0;
        return !(((_0_i).Sign != -1) && ((_0_i) < (new BigInteger((this.chain).Count)))) || ((new BigInteger(((this.chain).Select(_0_i).hash).Count)).Sign == 1);
      }))));
    }
    public void __ctor()
    {
      Transaction _0_firstTransaction;
      Transaction _nw0 = new Transaction();
      _nw0.__ctor(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("first"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("first"), BigInteger.One);
      _0_firstTransaction = _nw0;
      Block _1_firstBlock;
      Block _nw1 = new Block();
      _nw1.__ctor(BigInteger.One, Dafny.Sequence<Transaction>.FromElements(_0_firstTransaction), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("0"));
      _1_firstBlock = _nw1;
      (_1_firstBlock).hash = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("genesisHash");
      (this).chain = Dafny.Sequence<Block>.FromElements(_1_firstBlock);
    }
    public bool AddBlock(Block newBlock)
    {
      bool success = false;
      BigInteger _0_length;
      _0_length = new BigInteger((this.chain).Count);
      if ((newBlock.previousHash).Equals((this.chain).Select((_0_length) - (BigInteger.One)).hash)) {
        (this).chain = Dafny.Sequence<Block>.Concat(this.chain, Dafny.Sequence<Block>.FromElements(newBlock));
        success = true;
      } else {
        success = false;
      }
    ...
    {
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Blockchain:\n")).ToVerbatimString(false));
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      while ((_0_i) < (new BigInteger((this.chain).Count))) {
        ((this.chain).Select(_0_i)).PrintBlock();
        _0_i = (_0_i) + (BigInteger.One);
      }
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("End of Blockchain\n")).ToVerbatimString(false));
    }
  }
